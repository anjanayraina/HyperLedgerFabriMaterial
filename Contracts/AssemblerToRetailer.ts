...
export class AssetTransferContract extends Contract {
    ...
    public async InitLedger(ctx: Context): Promise<void> {
        ...
        for (const asset of assets) {
            ...
            await ctx.stub.putState(asset.imeiNumber, Buffer.from(stringify(sortKeysRecursive(asset))));
            console.info(`Asset ${asset.imeiNumber} initialized`);
        }
    }
